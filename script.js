  ...
  <div class="card__img">
    <div class="card__overlay">
      <button class="card__btn">
        <svg class="card__icon" viewBox="0 0 27 25" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <img src="img/product1.jpg" alt="product-1" class="card__img-img">
  </div>
